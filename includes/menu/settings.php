...
class class_job_bm_report_settings_page  {
	...
	public function job_bm_report_settings_options($options = array()){
			...
			$job_bm_report_list_user_role = $class_wp_ld_functions->job_bm_report_list_user_role();
...
<div class="wrap">
	...
	<div id="icon-tools" class="icon32"><br></div><?php echo "<h2>".__(wp_ld_plugin_name.' Settings', 'bsm')."</h2>";?>
